...
export default function NewVisit() {
  ...
  const registerPatient = async () => {
    ...
    await registerMutation.mutateAsync({
      ...
      contactNumber: registration.contactNumber, email: registration.email || undefined, address: registration.address || undefined,
    });
  };
