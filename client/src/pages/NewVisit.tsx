...
export default function NewVisit() {
  ...
  const brandedPrint = trpc.consultations.getBrandedPrintData.useMutation({
    onSuccess: (printData) => {
      ...
      if (!printWindow) { toast.error("Allow pop-ups to print the OP."); return; }
