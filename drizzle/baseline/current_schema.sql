...
CREATE INDEX `scannedGoodsReceiptItems_catalog_batch_idx` ON `scannedGoodsReceiptItems` (`catalogItemId`,`batchNumber`,`expiryDate`);
CREATE INDEX `scannedGoodsReceipts_receivedAt_idx` ON `scannedGoodsReceipts` (`receivedAt`);
